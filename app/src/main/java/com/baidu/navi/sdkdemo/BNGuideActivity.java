...
public class BNGuideActivity extends Activity {
    ...
    /*对于导航模块有两种方式来实现发起导航。 1：使用通用接口来实现 2：使用传统接口来实现。 useCommonInterface:是否使用通用接口*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (useCommonInterface) {
            ...
            //使用传统接口
            view = BNRouteGuideManager.getInstance()
    ...
    private void addCustomizedLayerItems() {
        ...
        if (mBNRoutePlanNode != null) {
            ...
            BNRouteGuideManager.getInstance()
                               .setCustomizedLayerItems(items);
        }
        BNRouteGuideManager.getInstance()
                           .showCustomizedLayer(true);
    }
